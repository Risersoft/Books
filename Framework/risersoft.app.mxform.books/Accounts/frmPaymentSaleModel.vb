...
<DataContract>
Public Class frmPaymentSaleModel
    ...
    Private Sub InitForm()
        ...
        sql = "Select CampusID, DispName, CompanyID, DivisionCodeList, WODate, CompletedOn,TaxAreaID, campuscode from mmlistCampus()  Order by DispName"
        ...
        sql = "Select CodeWord, DescripShort, CodeClass, Tag from CodeWords  where CodeClass = 'Invoice' and CodeType in ('B2c')  Order by CodeClass"
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        Dim sql As String, objPaymentSale As New clsPaymentFICO("PSA", myContext)
        ...
        If frmMode = EnumfrmMode.acAddM Then
            ...
            myRow("GSTInvoiceType") = "B2C"
        Else
            Dim rPostPeriod As DataRow = objPaymentSale.oMasterFICO.rPostPeriod(myUtils.cValTN(myRow("PostPeriodID")))
        ...
        objPaymentSale.LoadVouch(myUtils.cValTN(myRow("PaymentID")))
    ...
    Private Sub BindDataTable(ByVal PaymentID As Integer)
        ...
        Sql1 = "Select PaymentItemTransID, PaymentID, ClassType, TransType,ItemUnitID, ValuationClass, PriceSlabID,HSN_SC,TaxCredit, UnitName,BasicRate, AmountBasic, PPSubType, Description, QtyRate, AmountTot, AmountWV from PaymentItemTrans" &
    ...
    Public Overrides Function VSave() As Boolean
        ...
        If Me.Validate Then
            Dim objPaymentSale As New clsPaymentFICO("PSA", myContext)
            objPaymentSale.LoadVouch(myUtils.cValTN(myRow("PaymentID")))
            ...
            myRow("DocType") = objPaymentSale.DocType
            ...
            objPaymentSale.GenerateVoucherDelta(myRow.Row.Table, dsForm.Tables("PaymentItemTrans"))
            Oret = objPaymentSale.CheckBalance()
            ...
            If Me.CanSave Then
                ...
                ObjVouch.GetNewSerialNo("PaymentID", "PSA", myRow.Row)

                Dim oProc As New clsGSTPaymentSale(myContext)
                ...
                If myUtils.IsInList(myUtils.cStrTN(myRow("GSTInvoiceType")), "B2C") Then
                    If myUtils.cValTN(myRow("AmountTotPay")) > 250000 AndAlso myUtils.IsInList(myUtils.cStrTN(myRow("sply_ty")), "INTER") Then
                ...
                Try
                    ...
                    Oret = objPaymentSale.HandleWorkflowState(myRow.Row)
